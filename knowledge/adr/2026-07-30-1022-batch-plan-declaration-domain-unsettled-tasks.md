...
decisions:
  - id: D1
    review_finding_ref: "review_finding:PR #228 review round 1 re-entry (finding 2 の delta 受入により追加実装タスクが必要となり、batch-plan.json 不在の admission fail-closed と全タスク宣言要求が両立しないことが判明)"
  ...
  - id: D2
    ...
    status: proposed
  - id: D3
    review_finding_ref: "review_finding:adr scope final round 2026-07-30 (P1: D1 で未宣言となった settle 済みタスクが done -> in_progress の reopen で無判定に unsettled 化し、D1 の宣言要求が破れる)"
