...
decisions:
  - id: D1
    ...
    status: proposed
  - id: D2
    user_decision_ref: "chat_segment:session_019teXQcz3EK3Eh7fLm7XCTP:2026-07-23"
    status: proposed
  - id: D3
    user_decision_ref: "chat_segment:session_67282137-412e-4cc0-b687-505dd036e653:2026-07-23"
    status: proposed
...
本決定は ADR 2026-07-02-0359 の D6 が定めた existence-based scope のうち「obligations / test-bindings artifact が不在なら zero pairs で通過する」という規則を、catalogue が存在する track に限って supersede し、catalogue を持たない track に対する同規則は維持する。
