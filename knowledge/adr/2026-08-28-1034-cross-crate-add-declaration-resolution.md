...
decisions:
  - id: D1
    user_decision_ref: "chat_segment:grok-session-2026-08-28 Phase 0 boundary final approval of the converged text (D1 same-track other-layer add declarations in the resolution set, D2 declaring-layer identity and placement; rustdoc-wins; no extra referencing-catalogue description)"
    status: proposed
  - id: D2
    user_decision_ref: "chat_segment:grok-session-2026-08-28 Phase 0 boundary final approval of the converged text (D1 same-track other-layer add declarations in the resolution set, D2 declaring-layer identity and placement; rustdoc-wins; no extra referencing-catalogue description)"
    status: proposed
