...
decisions:
  - id: D1
    review_finding_ref: "types final P1: enforcement-owner contradiction on usecase-types.json GateRunCommandError::EncodedNameTooLong; rollback-diagnoser routing: adr"
    status: proposed
  - id: D2
    review_finding_ref: "infrastructure final P1: directory rename after reserve can write outside the trusted root"
    status: proposed
  - id: D3
    review_finding_ref: "infrastructure final P2: unbounded reservation registry and unspecified drop/cancel/shutdown lifecycle"
    status: proposed
---
