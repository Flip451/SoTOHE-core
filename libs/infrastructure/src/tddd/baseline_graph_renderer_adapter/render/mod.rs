...
pub(super) mod cluster_key;
pub(super) mod edge_collector;
pub(super) mod entry_emitter;
pub(super) mod entry_subgraph;
pub(super) mod impl_processor;
pub(super) mod node_extractor;
pub(super) mod node_id_generator;
pub(super) mod style_config;
pub(super) mod trait_index;
pub(super) mod type_resolver;
...
use cluster_key::{ClusterKey, build_node_cluster_map, cluster_key_from_path, lookup_cluster};
use edge_collector::collect_entry_edge_pairs;
use node_extractor::extract_nodes;
use style_config::{apply_shape, class_def_line, layer_subgraph_id, sanitize};

// Re-export StyleConfig so the parent module can reference `render::StyleConfig`.
pub(super) use style_config::StyleConfig;
...
mod tests {
    use super::style_config::{EdgeStyle, edge_arrow_label};
    use super::*;
