...
- **Planner capability**: default profile uses Claude Opus (`claude-opus-4-6`) via `claude --bare -p`. This is `capabilities.planner.model` in `.harness/config/agent-profiles.json`.
