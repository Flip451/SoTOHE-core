...
- After writing spec.json, run `cargo make track-sync-views` to generate `spec.md` as a read-only rendered view from spec.json. Do NOT write `spec.md` directly — it is generated by `render_spec()`.
