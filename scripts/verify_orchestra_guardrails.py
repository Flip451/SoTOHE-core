...
EXPECTED_CARGO_MAKE_ALLOW = {
    ...
    "Bash(cargo make takt-failure-report:*)": "takt failure report permission",
    "Bash(cargo make takt-add:*)": "cargo make takt-add permission",
    "Bash(cargo make takt-run)": "cargo make takt-run permission",
    "Bash(cargo make takt-render-personas)": "cargo make takt-render-personas permission",
    "Bash(cargo make takt-full-cycle:*)": "cargo make takt-full-cycle permission",
    "Bash(cargo make takt-spec-to-impl:*)": "cargo make takt-spec-to-impl permission",
...
EXPECTED_DENY = {
    ...
    "Read(./.cache/takt-uv/**)": "takt uv cache read deny rule",
    "Grep(./.cache/takt-uv/**)": "takt uv cache grep deny rule",
