...
- Required reading before writing: `knowledge/conventions/README.md`, `knowledge/conventions/pre-track-adr-authoring.md`, `.harness/policies/track-lifecycle.md`, the target ADRs under `knowledge/adr/`, and `track/items/<id>/metadata.json`. If a referenced convention exists for the feature domain, read it before drafting.
