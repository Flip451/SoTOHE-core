...
2. **This capability definition** (v3 schema reference + action semantics + sample JSON in `## Catalogue Pattern Cookbook`) — authoritative for JSON structure, action semantics, and evaluator / codec behavior
