...
subgraph domain["domain"]
  ...
  subgraph T32_domain_domain_AdmissionRejection["batch_plan::AdmissionRejection"]
    ...
    T32_domain_domain_AdmissionRejection_NoCurrentBatch[NoCurrentBatch]
  ...
  subgraph T38_domain_domain_BatchPlanValidationError["batch_plan::BatchPlanValidationError"]
    ...
    T38_domain_domain_BatchPlanValidationError_EmptyScopeEstimates[EmptyScopeEstimates]
...
subgraph usecase["usecase"]
  ...
  subgraph T35_usecase_usecase_BatchPlanCheckError["batch_plan::BatchPlanCheckError"]
    ...
    T35_usecase_usecase_BatchPlanCheckError_TrackResolutionFailed[TrackResolutionFailed]
  end
  ...
  subgraph T36_usecase_usecase_BatchPlanCheckOutput["batch_plan::BatchPlanCheckOutput"]
    direction TB
    T36_usecase_usecase_BatchPlanCheckOutput__self[BatchPlanCheckOutput]
    T36_usecase_usecase_BatchPlanCheckOutput_Passed[Passed]
    T36_usecase_usecase_BatchPlanCheckOutput_Blocked[Blocked]
  end
  subgraph T40_usecase_usecase_BatchPlanViolationOutput["batch_plan::BatchPlanViolationOutput"]
    direction TB
    T40_usecase_usecase_BatchPlanViolationOutput__self[BatchPlanViolationOutput]
    T40_usecase_usecase_BatchPlanViolationOutput_CeilingExceeded[CeilingExceeded]
    T40_usecase_usecase_BatchPlanViolationOutput_OversizeScopeHasMultipleContributors[OversizeScopeHasMultipleContributors]
  ...
  subgraph T40_usecase_usecase_NonEmptyViolationOutputs["batch_plan::NonEmptyViolationOutputs"]
    direction TB
    T40_usecase_usecase_NonEmptyViolationOutputs__self[NonEmptyViolationOutputs]
    T40_usecase_usecase_NonEmptyViolationOutputs_try_new([try_new])
    T40_usecase_usecase_NonEmptyViolationOutputs_as_slice([as_slice])
    T40_usecase_usecase_NonEmptyViolationOutputs_into_vec([into_vec])
  end
  subgraph T37_usecase_usecase_PlanArtifactReadError["batch_plan::PlanArtifactReadError"]
    direction TB
    T37_usecase_usecase_PlanArtifactReadError__self[PlanArtifactReadError]
    T37_usecase_usecase_PlanArtifactReadError_NotFound[NotFound]
    T37_usecase_usecase_PlanArtifactReadError_ReadFailed[ReadFailed]
  end
  ...
  subgraph R35_usecase_usecase_BatchPlanReaderPort["batch_plan::ports::BatchPlanReaderPort"]
    direction TB
    R35_usecase_usecase_BatchPlanReaderPort__self[BatchPlanReaderPort]
    R35_usecase_usecase_BatchPlanReaderPort_read([read])
  end
  subgraph R37_usecase_usecase_PlannedTaskReaderPort["batch_plan::ports::PlannedTaskReaderPort"]
    direction TB
  ...
  subgraph R37_usecase_usecase_ScopeConfigReaderPort["batch_plan::ports::ScopeConfigReaderPort"]
    direction TB
  ...
  subgraph usecase_usecase_module_task_ops["usecase::task_ops"]
    direction TB
  subgraph T40_usecase_usecase_AdmissionRejectionOutput["task_ops::AdmissionRejectionOutput"]
    direction TB
    T40_usecase_usecase_AdmissionRejectionOutput__self[AdmissionRejectionOutput]
    T40_usecase_usecase_AdmissionRejectionOutput_NotCurrentBatchMember[NotCurrentBatchMember]
    T40_usecase_usecase_AdmissionRejectionOutput_NoCurrentBatch[NoCurrentBatch]
    T40_usecase_usecase_AdmissionRejectionOutput_ScopeCeilingWouldBeExceeded[ScopeCeilingWouldBeExceeded]
  end
  subgraph T39_usecase_usecase_CommitRecordVerifyError["task_ops::CommitRecordVerifyError"]
    direction TB
    T39_usecase_usecase_CommitRecordVerifyError__self[CommitRecordVerifyError]
    T39_usecase_usecase_CommitRecordVerifyError_CommitNotFound[CommitNotFound]
    T39_usecase_usecase_CommitRecordVerifyError_NotAncestorOfHead[NotAncestorOfHead]
    T39_usecase_usecase_CommitRecordVerifyError_RepositoryUnreadable[RepositoryUnreadable]
  end
  ...
  subgraph R40_usecase_usecase_CommitRecordVerifierPort["task_ops::ports::CommitRecordVerifierPort"]
    direction TB
    R40_usecase_usecase_CommitRecordVerifierPort__self[CommitRecordVerifierPort]
    R40_usecase_usecase_CommitRecordVerifierPort_verify_commit_record([verify_commit_record])
  end
...
subgraph infrastructure["infrastructure"]
  ...
  subgraph infrastructure_infrastructure_module_branch_reader["infrastructure::branch_reader"]
    direction TB
  subgraph T46_infrastructure_infrastructure_LazyBranchReader["branch_reader::LazyBranchReader"]
    direction TB
    T46_infrastructure_infrastructure_LazyBranchReader__self[LazyBranchReader]
    T46_infrastructure_infrastructure_LazyBranchReader_new([new])
  end
  end
  subgraph infrastructure_infrastructure_module_commit_record_verifier["infrastructure::commit_record_verifier"]
    direction TB
  subgraph T53_infrastructure_infrastructure_GitCommitRecordVerifier["commit_record_verifier::GitCommitRecordVerifier"]
    direction TB
    T53_infrastructure_infrastructure_GitCommitRecordVerifier__self[GitCommitRecordVerifier]
    T53_infrastructure_infrastructure_GitCommitRecordVerifier_new([new])
  end
  end
...
T32_domain_domain_AdmissionRejection_NoCurrentBatch --o|task_batch| T21_domain_domain_BatchId__self
...
T36_usecase_usecase_BatchPlanCheckOutput_Blocked --o|violations| T40_usecase_usecase_NonEmptyViolationOutputs__self
T40_usecase_usecase_NonEmptyViolationOutputs_try_new --o T40_usecase_usecase_BatchPlanViolationOutput__self
T40_usecase_usecase_NonEmptyViolationOutputs_try_new --> T40_usecase_usecase_NonEmptyViolationOutputs__self
T40_usecase_usecase_NonEmptyViolationOutputs_as_slice --> T40_usecase_usecase_BatchPlanViolationOutput__self
T40_usecase_usecase_NonEmptyViolationOutputs_into_vec --> T40_usecase_usecase_BatchPlanViolationOutput__self
...
R37_usecase_usecase_BatchPlanCheckService_check --> T36_usecase_usecase_BatchPlanCheckOutput__self
R35_usecase_usecase_BatchPlanReaderPort_read --> T37_usecase_usecase_PlanArtifactReadError__self
R35_usecase_usecase_BatchPlanReaderPort_read --> T31_domain_domain_BatchPlanDocument__self
R37_usecase_usecase_PlannedTaskReaderPort_read_planned_tasks --> T37_usecase_usecase_PlanArtifactReadError__self
...
T39_usecase_usecase_TaskOperationInteractor_new --o R32_usecase_usecase_BranchReaderPort__self
...
T39_usecase_usecase_TaskOperationInteractor_new --o R40_usecase_usecase_CommitRecordVerifierPort__self
T39_usecase_usecase_TaskOperationInteractor_new --> T39_usecase_usecase_TaskOperationInteractor__self
T37_usecase_usecase_TaskTransitionOutcome_Rejected --o T40_usecase_usecase_AdmissionRejectionOutput__self
T37_usecase_usecase_TaskTransitionOutcome_rejection --> T40_usecase_usecase_AdmissionRejectionOutput__self
R40_usecase_usecase_CommitRecordVerifierPort_verify_commit_record --> T39_usecase_usecase_CommitRecordVerifyError__self
...
T46_infrastructure_infrastructure_LazyBranchReader_new --> T46_infrastructure_infrastructure_LazyBranchReader__self
T53_infrastructure_infrastructure_GitCommitRecordVerifier_new --> T53_infrastructure_infrastructure_GitCommitRecordVerifier__self
...
T46_infrastructure_infrastructure_LazyBranchReader__self -.impl.-> R32_usecase_usecase_BranchReaderPort__self
T53_infrastructure_infrastructure_GitCommitRecordVerifier__self -.impl.-> R40_usecase_usecase_CommitRecordVerifierPort__self
...
class T32_domain_domain_AdmissionRejection_NoCurrentBatch variant_node
...
class T38_domain_domain_BatchPlanValidationError_EmptyScopeEstimates variant_node
...
class T35_usecase_usecase_BatchPlanCheckError_TrackResolutionFailed variant_node
...
class T36_usecase_usecase_BatchPlanCheckOutput_Passed variant_node
class T36_usecase_usecase_BatchPlanCheckOutput_Blocked variant_node
class T36_usecase_usecase_BatchPlanCheckOutput__self dto
class T40_usecase_usecase_BatchPlanViolationOutput_CeilingExceeded variant_node
class T40_usecase_usecase_BatchPlanViolationOutput_OversizeScopeHasMultipleContributors variant_node
...
class T40_usecase_usecase_NonEmptyViolationOutputs_into_vec method_node
class T40_usecase_usecase_NonEmptyViolationOutputs__self dto
class T37_usecase_usecase_PlanArtifactReadError_NotFound variant_node
class T37_usecase_usecase_PlanArtifactReadError_ReadFailed variant_node
class T37_usecase_usecase_PlanArtifactReadError__self error_type
...
class T40_usecase_usecase_AdmissionRejectionOutput_NotCurrentBatchMember variant_node
class T40_usecase_usecase_AdmissionRejectionOutput_NoCurrentBatch variant_node
class T40_usecase_usecase_AdmissionRejectionOutput_ScopeCeilingWouldBeExceeded variant_node
class T40_usecase_usecase_AdmissionRejectionOutput__self dto
class T39_usecase_usecase_CommitRecordVerifyError_CommitNotFound variant_node
class T39_usecase_usecase_CommitRecordVerifyError_NotAncestorOfHead variant_node
class T39_usecase_usecase_CommitRecordVerifyError_RepositoryUnreadable variant_node
class T39_usecase_usecase_CommitRecordVerifyError__self error_type
...
class R40_usecase_usecase_CommitRecordVerifierPort_verify_commit_record method_node
class R40_usecase_usecase_CommitRecordVerifierPort__self secondary_port
...
class T46_infrastructure_infrastructure_LazyBranchReader_new method_node
class T46_infrastructure_infrastructure_LazyBranchReader__self secondary_adapter
class T53_infrastructure_infrastructure_GitCommitRecordVerifier_new method_node
class T53_infrastructure_infrastructure_GitCommitRecordVerifier__self secondary_adapter
