...
- [x] **T019**: `libs/domain/` の TrackTask に depends_on とアクセサ・それを受理する constructor を追加し、ValidationError variant と plan document constructor の検査を更新する。IN-19、IN-20、AC-21、AC-22。
