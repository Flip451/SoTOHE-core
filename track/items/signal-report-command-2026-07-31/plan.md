...
- [x] **T002**: After T001, implement the catalogue-defined infrastructure `SystemSignalReportSourceAdapter` in `libs/infrastructure/src/signal_report/`, with independently verifiable artifact-read, chain ⓪/① derivation, and non-persistence conformance tests. IN-04, CN-01, AC-04. (`43e23a96`)
...
- [x] **T003**: After T001, implement filter-to-query conversion in `apps/cli-driver/src/signal_report/`. IN-03, AC-03.
