...
- [x] Domain port traits (ReviewReader + ReviewReaderError, ReviewWriter + ReviewWriterError including init/reset semantics: reset archives then creates new review.json without clearing .commit_hash, CommitHashReader + CommitHashWriter + CommitHashError)
