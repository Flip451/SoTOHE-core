...
- [ ] Domain: add all_tasks_resolved() method to TrackMetadata
...
- [ ] CLI: add task completion guard to sotp pr push before git push
...
- [ ] Tests: guard blocks on unresolved tasks, passes on all done/skipped
