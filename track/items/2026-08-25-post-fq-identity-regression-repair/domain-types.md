...
| Name | Kind | Action | Details | Signal | Cat-Spec |
|------|------|--------|---------|--------|----------|
| AttestedCatalogueDocument | value_object | add | — | 🔵 | 🔵 |
| domain::tddd::catalogue::TypeSignal | value_object | modify | — | 🔵 | 🔵 |
...
| domain::tddd::catalogue_v2::identity_resolution::resolve_contract_entry_namespace | free_function | add | fn(document: &CatalogueDocument, entry_key: &CatalogueEntryKey) -> Result<Option<CatalogueItemNamespace>, CatalogueIdentityResolutionError> | 🔵 | 🔵 |

## Aggregate Roots

| Name | Kind | Action | Details | Signal | Cat-Spec |
|------|------|--------|---------|--------|----------|
| domain::tddd::catalogue_v2::document::CatalogueDocument | aggregate_root | reference | — | 🔵 | 🔵 |
