...
- [x] **T001**: Implement the T001 domain catalogue entries, including the recorded-copy state and aggregated fail-closed violation responsibilities, in `libs/domain/`; add focused domain tests. IN-01, IN-03, IN-05, CN-01, CN-02, CN-03, CN-04, CN-05, AC-02, AC-03, AC-06, AC-07.
...
- [x] **T003**: Implement the T003 filesystem/Git secondary-adapter and ledger-codec catalogue entries in `libs/infrastructure/` and add adapter and transaction regression tests. IN-01, IN-02, IN-03, IN-04, IN-05, CN-01, CN-02, CN-03, CN-04, CN-05, AC-01, AC-02, AC-03, AC-05, AC-06, AC-07.
...
- [x] **T004**: Implement the T004 `cli_driver` and `cli` catalogue entries for the ADR-baseline command boundary, including the unresolved composition-facing request, and add CLI-driver and argument-validation tests. IN-01, IN-02, IN-03, CN-02, CN-03, CN-04, AC-01, AC-06.
- [x] **T005**: Implement ADR-baseline CLI execution, root-command integration, retained dispatch plumbing, and composition-time resolution failures with `AdrBaselineCompositionRoot`; rebuild `bin/sotp` with `cargo make build-sotp`; and add command-level tests. IN-02, IN-03, CN-04, AC-03, AC-04.
