...
| AdrBaselineStorePort | secondary_port | add | fn snapshot(&self, track_id: &domain::TrackId, source: &domain::adr_baseline::AdrSourceFileName, bytes: Vec<u8>, kind: domain::adr_baseline::AdrBaselineKind, reason: Option<domain::NonEmptyString>) -> Result<domain::adr_baseline::AdrBaselineLedgerEntry, AdrBaselineStoreError>, fn restore(&self, track_id: &domain::TrackId, source: &domain::adr_baseline::AdrSourceFileName) -> Result<(), AdrBaselineStoreError> | 🟡 | 🔵 |
