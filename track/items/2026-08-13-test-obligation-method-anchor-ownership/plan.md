...
- [x] **T1**: Targets: libs/domain/src/tddd/catalogue_v2/methods.rs. Operation: implement and test lint remediation, accessors, the backward-compatible method-level spec_refs storage/accessor API, and compatibility staging. Anchors: GO-01, GO-02, IN-01, IN-05, AC-01, AC-06, CN-05, OS-05.
