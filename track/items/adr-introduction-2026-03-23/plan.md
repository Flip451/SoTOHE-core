...
- [x] knowledge/adr/README.md 作成（テンプレート + 運用ルール + 索引）
...
- [x] tmp/adr-drafts/ の 4 ADR を knowledge/adr/ に移動
...
- [x] DESIGN.md Key Design Decisions → 個別 ADR 分解（13 件）
...
- [x] project-docs/conventions/adr.md 作成 + CLAUDE.md 参照追加
