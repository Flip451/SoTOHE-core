...
- [ ] **T001**: Update the Phase 1+ escalation-lane guidance in `knowledge/conventions/pre-track-adr-authoring.md`. Validate the document against D6; IN-01, CN-01, and AC-01.
...
- [ ] **T002**: Update the guardian escalation-lane guidance in `.harness/capabilities/adr-diagnoser.md`, `.agents/skills/adr-diagnoser/SKILL.md`, and `.harness/capabilities/adr-editor.md`. Validate the documents against D5, D6, and D7; IN-02, IN-03, CN-01, CN-02, CN-03, AC-02, AC-03, and AC-04.
...
- [ ] **T003**: Update escalation-lane guidance in `.harness/workflows/track/review.md`, `.harness/workflows/track/plan.md`, and `.harness/workflows/track/adr2pr.md`. Validate the documents against D5, D6, and D7; IN-02, IN-03, CN-01, CN-02, CN-03, AC-01, AC-02, AC-03, and AC-04.
