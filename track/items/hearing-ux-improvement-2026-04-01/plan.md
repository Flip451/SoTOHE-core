...
- [ ] TSUMIKI-06 モード選択 — SKILL.md に Step 0 挿入（Full/Focused/Quick）
...
- [ ] TSUMIKI-07 HearingRecord — Rust domain + infra + render 実装（TDD）
...
- [ ] TSUMIKI-05 構造化質問 — SKILL.md Step 4a を AskUserQuestion + multiSelect に書き換え
