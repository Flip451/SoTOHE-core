...
- [x] **T003**: `knowledge/conventions/pre-track-adr-authoring.md` 機構との整合: add the D3 escalation-reason clarification sentence, anchored to `knowledge/adr/2026-07-18-0340-adr2pr-baseline-diff-comment.md` D3 (IN-03/AC-07).
