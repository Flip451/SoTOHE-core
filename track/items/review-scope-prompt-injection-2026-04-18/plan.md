...
内容は knowledge/research/2026-04-18-0514-planner-review-scope-prompt-injection.md の Canonical Block 'plan-artifacts.md (initial body)' の 2 policy section: What to report (5 カテゴリ) と What NOT to report (4 カテゴリ)。canonical block の冒頭 scope paragraph ('This policy applies...') は main briefing で既に提供されるため省略 (reviewer が他 doc 参照せず policy を適用できる self-contained 性は維持)。round budget / round 数 cap は含めない — orchestrator pacing に属する
...
- [x] Create directory track/review-prompts/ and file track/review-prompts/plan-artifacts.md. Content: both policy sections from the Canonical Block 'plan-artifacts.md (initial body)' in knowledge/research/2026-04-18-0514-planner-review-scope-prompt-injection.md — What to report (factual error, contradiction, broken reference, infeasibility, timestamp inconsistency) and What NOT to report (wording nits, English/Japanese mix unless style rule violated, alternative design suggestions post-planning-gate, formatting preferences). Note: the canonical block's opening scope paragraph ('This policy applies when...') was omitted as it duplicates information already present in the injected main briefing; the two policy sections are sufficient for the reviewer to apply the filter without other docs. The markdown is self-contained for policy application. Do NOT include a round budget / round count target. Note: briefing_file CI lint (verify-doc-links checking JSON briefing_file entries) is deferred to Open Question Q3. The file has been created; runtime verification that the reviewer can Read the file via its Read tool is scheduled for T008 dogfooding (still pending).
