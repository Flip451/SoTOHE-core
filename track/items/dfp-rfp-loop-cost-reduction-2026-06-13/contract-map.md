...
subgraph domain["domain"]
  ...
  subgraph T39_domain_domain_DryCheckCorpusFingerprint["dry_check::DryCheckCorpusFingerprint"]
    direction TB
    T39_domain_domain_DryCheckCorpusFingerprint__self[DryCheckCorpusFingerprint]
    T39_domain_domain_DryCheckCorpusFingerprint_new([new])
    T39_domain_domain_DryCheckCorpusFingerprint_fail_closed([fail_closed])
    T39_domain_domain_DryCheckCorpusFingerprint_as_str([as_str])
  end
  subgraph T44_domain_domain_DryCheckCorpusFingerprintError["dry_check::DryCheckCorpusFingerprintError"]
    direction TB
    T44_domain_domain_DryCheckCorpusFingerprintError__self[DryCheckCorpusFingerprintError]
    T44_domain_domain_DryCheckCorpusFingerprintError_InvalidFormat[InvalidFormat]
  end
  subgraph T36_domain_domain_DryCheckCoverageRecord["dry_check::DryCheckCoverageRecord"]
    ...
    T36_domain_domain_DryCheckCoverageRecord_fragment_refs([fragment_refs])
    T36_domain_domain_DryCheckCoverageRecord_processed_pair_keys([processed_pair_keys])
    T36_domain_domain_DryCheckCoverageRecord_config_fingerprint([config_fingerprint])
    T36_domain_domain_DryCheckCoverageRecord_corpus_fingerprint([corpus_fingerprint])
...
subgraph infrastructure["infrastructure"]
  ...
  F91_infrastructure_infrastructure_infrastructure__dry_check__corpus__compute_corpus_fingerprint[[compute_corpus_fingerprint]]
...
T39_domain_domain_DryCheckCorpusFingerprint_new --> T39_domain_domain_DryCheckCorpusFingerprint__self
T39_domain_domain_DryCheckCorpusFingerprint_new --> T44_domain_domain_DryCheckCorpusFingerprintError__self
T39_domain_domain_DryCheckCorpusFingerprint_fail_closed --> T39_domain_domain_DryCheckCorpusFingerprint__self
T36_domain_domain_DryCheckCoverageRecord_new --o T39_domain_domain_DryCheckConfigFingerprint__self
T36_domain_domain_DryCheckCoverageRecord_new --o T39_domain_domain_DryCheckCorpusFingerprint__self
...
T36_domain_domain_DryCheckCoverageRecord_corpus_fingerprint --> T39_domain_domain_DryCheckCorpusFingerprint__self
...
T42_usecase_usecase_DryCheckApprovalInteractor_new --o T39_domain_domain_DryCheckCorpusFingerprint__self
T42_usecase_usecase_DryCheckApprovalInteractor_new --> T42_usecase_usecase_DryCheckApprovalInteractor__self
T30_usecase_usecase_DryCheckConfig_new --o T31_usecase_usecase_DryCheckPercent__self
T30_usecase_usecase_DryCheckConfig_new --o T31_usecase_usecase_DryCheckPercent__self
T30_usecase_usecase_DryCheckConfig_new --o T35_usecase_usecase_DryCheckParallelism__self
...
T34_usecase_usecase_DryCheckInteractor_new --o T39_domain_domain_DryCheckCorpusFingerprint__self
...
T44_infrastructure_infrastructure_DryCheckConfig_fingerprint_with_threshold --> T39_domain_domain_DryCheckConfigFingerprint__self
T44_infrastructure_infrastructure_DryCheckConfig_fingerprint --> T39_domain_domain_DryCheckConfigFingerprint__self
...
F91_infrastructure_infrastructure_infrastructure__dry_check__corpus__compute_corpus_fingerprint --> T39_domain_domain_DryCheckCorpusFingerprint__self
...
class T39_domain_domain_DryCheckCorpusFingerprint_new method_node
class T39_domain_domain_DryCheckCorpusFingerprint_fail_closed method_node
class T39_domain_domain_DryCheckCorpusFingerprint_as_str method_node
class T39_domain_domain_DryCheckCorpusFingerprint__self value_object
class T44_domain_domain_DryCheckCorpusFingerprintError_InvalidFormat variant_node
class T44_domain_domain_DryCheckCorpusFingerprintError__self error_type
class T36_domain_domain_DryCheckCoverageRecord_new method_node
class T36_domain_domain_DryCheckCoverageRecord_fragment_refs method_node
class T36_domain_domain_DryCheckCoverageRecord_processed_pair_keys method_node
class T36_domain_domain_DryCheckCoverageRecord_config_fingerprint method_node
class T36_domain_domain_DryCheckCoverageRecord_corpus_fingerprint method_node
...
class F91_infrastructure_infrastructure_infrastructure__dry_check__corpus__compute_corpus_fingerprint free_function
class F91_infrastructure_infrastructure_infrastructure__dry_check__corpus__compute_corpus_fingerprint function_node
