...
- [x] **T001**: Update .harness/reference/catalogue-schema.md with lifetime trait-implementation spelling, inherent-method placement, and single-trailing-private-tuple-field guidance; IN-01, CN-01, CN-02, AC-01, AC-02. (`ba54804901b941896f4ec0f2e0c595733d025e62`)
...
- [x] **T003**: Align the impl_generics DTO documentation in libs/domain/src/tddd/catalogue_v2/entries.rs and traits.rs with the supported lifetime declaration spelling; IN-02, CN-01, AC-03. (`ba54804901b941896f4ec0f2e0c595733d025e62`)
...
- [x] **T002**: Update positional-key handling and add focused regression coverage in libs/infrastructure/src/tddd/signal_evaluator_v2/structural_eq.rs; IN-03, IN-04, CN-03, CN-04, AC-04, AC-05, AC-06. (`ba54804901b941896f4ec0f2e0c595733d025e62`)
