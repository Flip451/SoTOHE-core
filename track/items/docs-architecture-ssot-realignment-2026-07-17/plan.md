...
- [x] **T004**: `overlay/knowledge/adr/README.md`; `knowledge/adr/README.md`: update both ADR templates to the current front-matter format (IN-08/AC-09).

### S5 — Release-PR CI gate exception

> Execute T005 for the cited CI workflow conditions and comment (IN-09/CN-03/AC-10).

- [x] **T005**: `.github/workflows/ci.yml`: update the track-aware gate and branch-recreation conditions and their relationship comment (IN-09/CN-03/AC-10).
