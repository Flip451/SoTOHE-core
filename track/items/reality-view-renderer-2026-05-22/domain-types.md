...
| BaselineGraphRenderer | secondary_port | — | fn render_overview(&self, baselines: &[BaselineDocument], layer: &LayerId) -> Result<String, BaselineGraphRendererError>, fn render_cluster(&self, baselines: &[BaselineDocument], layer: &LayerId, cluster_crate: &CrateName, cluster_module: &str) -> Result<String, BaselineGraphRendererError> | 🔵 | 🔵 |
