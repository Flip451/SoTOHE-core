...
| TrackNextTaskQueryPort | secondary_port | add | fn next_task(&self, command: TrackNextTaskCommand) -> Result<Option<NextTaskOutput>, TaskOperationError> | 🟡 | 🔵 |
| TrackOverrideClearPort | secondary_port | add | fn clear_override(&self, command: TrackClearOverrideCommand) -> Result<TaskOperationOutput, TaskOperationError> | 🟡 | 🔵 |
| TrackOverrideSetPort | secondary_port | add | fn set_override(&self, command: TrackSetOverrideCommand) -> Result<TaskOperationOutput, TaskOperationError> | 🟡 | 🔵 |
...
| TrackTaskAddPort | secondary_port | add | fn add_task(&self, command: TrackAddTaskCommand) -> Result<TaskOperationOutput, TaskOperationError> | 🟡 | 🔵 |
| TrackTaskCountsQueryPort | secondary_port | add | fn task_counts(&self, command: TrackTaskCountsCommand) -> Result<TaskCountsOutput, TaskOperationError> | 🟡 | 🔵 |
| TrackTaskTransitionPort | secondary_port | add | fn transition_task(&self, command: TrackTransitionCommand) -> Result<TaskTransitionOutcome, TaskOperationError> | 🟡 | 🔵 |
