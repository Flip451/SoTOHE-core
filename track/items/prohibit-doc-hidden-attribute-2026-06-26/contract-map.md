...
subgraph infrastructure["infrastructure"]
  ...
  subgraph infrastructure_infrastructure_module_verify["infrastructure::verify"]
    direction TB
  subgraph T44_infrastructure_infrastructure_SynScanContext["verify::syn_scan::SynScanContext"]
    direction TB
    T44_infrastructure_infrastructure_SynScanContext__self[SynScanContext]
  end
  F72_infrastructure_infrastructure_infrastructure__verify__doc_hidden__verify[[verify]]
  F91_infrastructure_infrastructure_infrastructure__verify__syn_scan__scan_workspace_rust_sources[[scan_workspace_rust_sources]]
  end
...
subgraph cli["cli"]
  direction TB
  F37_cli_cli_cli__verify_command_gate_name[[verify_command_gate_name]]
...
T21_cli_cli_VerifyCommand_TechStack --o T18_cli_cli_VerifyArgs__self
...
T21_cli_cli_VerifyCommand_DocHidden --o T18_cli_cli_VerifyArgs__self
...
class T44_infrastructure_infrastructure_SynScanContext__self dto
...
class F91_infrastructure_infrastructure_infrastructure__verify__syn_scan__scan_workspace_rust_sources free_function
class F91_infrastructure_infrastructure_infrastructure__verify__syn_scan__scan_workspace_rust_sources function_node
...
class F37_cli_cli_cli__verify_command_gate_name free_function
class F37_cli_cli_cli__verify_command_gate_name function_node
