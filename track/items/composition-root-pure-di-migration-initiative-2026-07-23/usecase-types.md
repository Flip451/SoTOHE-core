...
| AdrBaselineStorePort | secondary_port | reference | fn snapshot(&self, track_id: &domain::TrackId, source: &domain::adr_baseline::AdrSourceFileName, bytes: std::vec::Vec<u8>, kind: domain::adr_baseline::AdrBaselineKind, reason: core::option::Option<domain::NonEmptyString>, timestamp: domain::Timestamp) -> core::result::Result<domain::adr_baseline::AdrBaselineLedgerEntry, AdrBaselineStoreError>, fn restore(&self, track_id: &domain::TrackId, source: &domain::adr_baseline::AdrSourceFileName) -> core::result::Result<(), AdrBaselineStoreError> | 🔵 | 🔵 |
