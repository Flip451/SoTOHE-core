...
subgraph usecase["usecase"]
  ...
  subgraph T39_usecase_usecase_AdrBaselineSnapshotKind["adr_baseline::AdrBaselineSnapshotKind"]
    direction TB
    T39_usecase_usecase_AdrBaselineSnapshotKind__self[AdrBaselineSnapshotKind]
    T39_usecase_usecase_AdrBaselineSnapshotKind_Init[Init]
    T39_usecase_usecase_AdrBaselineSnapshotKind_Cite[Cite]
    T39_usecase_usecase_AdrBaselineSnapshotKind_NewAdr[NewAdr]
    T39_usecase_usecase_AdrBaselineSnapshotKind_NonSemanticFix[NonSemanticFix]
    T39_usecase_usecase_AdrBaselineSnapshotKind_Escalation[Escalation]
    T39_usecase_usecase_AdrBaselineSnapshotKind_uses_fork_point([uses_fork_point])
    T39_usecase_usecase_AdrBaselineSnapshotKind_into_ledger_parts([into_ledger_parts])
  end
...
subgraph infrastructure["infrastructure"]
  direction TB
  F59_infrastructure_infrastructure_infrastructure__timestamp_now[[timestamp_now]]
  ...
  F73_infrastructure_infrastructure_infrastructure__adr_baseline__timestamp_now[[timestamp_now]]
  end
...
subgraph cli_driver["cli_driver"]
  ...
  subgraph T46_cli_driver_cli_driver_AdrBaselineSnapshotInput["adr_baseline::AdrBaselineSnapshotInput"]
    direction TB
    T46_cli_driver_cli_driver_AdrBaselineSnapshotInput__self[AdrBaselineSnapshotInput]
    T46_cli_driver_cli_driver_AdrBaselineSnapshotInput_Init[Init]
    T46_cli_driver_cli_driver_AdrBaselineSnapshotInput_Cite[Cite]
    T46_cli_driver_cli_driver_AdrBaselineSnapshotInput_NewAdr[NewAdr]
    T46_cli_driver_cli_driver_AdrBaselineSnapshotInput_NonSemanticFix[NonSemanticFix]
    T46_cli_driver_cli_driver_AdrBaselineSnapshotInput_Escalation[Escalation]
  end
  end
...
subgraph cli["cli"]
  ...
  subgraph cli_cli_module_commands["cli::commands"]
    direction TB
  F53_cli_cli_cli__commands__adr_baseline__resolve_for_read[[resolve_for_read]]
  F54_cli_cli_cli__commands__adr_baseline__resolve_for_write[[resolve_for_write]]
  end
end
T34_usecase_usecase_AdrBaselineCommand_Snapshot --o|kind| T39_usecase_usecase_AdrBaselineSnapshotKind__self
...
R36_usecase_usecase_AdrBaselineStorePort_snapshot --o T39_usecase_usecase_AdrBaselineSnapshotKind__self
...
F73_infrastructure_infrastructure_infrastructure__adr_baseline__timestamp_now --> T41_usecase_usecase_AdrBaselineTimestampError__self
...
T38_cli_driver_cli_driver_AdrBaselineInput_Snapshot --o|kind| T46_cli_driver_cli_driver_AdrBaselineSnapshotInput__self
...
class T39_usecase_usecase_AdrBaselineSnapshotKind_Init variant_node
class T39_usecase_usecase_AdrBaselineSnapshotKind_Cite variant_node
class T39_usecase_usecase_AdrBaselineSnapshotKind_NewAdr variant_node
class T39_usecase_usecase_AdrBaselineSnapshotKind_NonSemanticFix variant_node
class T39_usecase_usecase_AdrBaselineSnapshotKind_Escalation variant_node
class T39_usecase_usecase_AdrBaselineSnapshotKind_uses_fork_point method_node
class T39_usecase_usecase_AdrBaselineSnapshotKind_into_ledger_parts method_node
class T39_usecase_usecase_AdrBaselineSnapshotKind__self dto
...
class F59_infrastructure_infrastructure_infrastructure__timestamp_now free_function
class F59_infrastructure_infrastructure_infrastructure__timestamp_now function_node
...
class F73_infrastructure_infrastructure_infrastructure__adr_baseline__timestamp_now free_function
class F73_infrastructure_infrastructure_infrastructure__adr_baseline__timestamp_now function_node
...
class T46_cli_driver_cli_driver_AdrBaselineSnapshotInput_Init variant_node
class T46_cli_driver_cli_driver_AdrBaselineSnapshotInput_Cite variant_node
class T46_cli_driver_cli_driver_AdrBaselineSnapshotInput_NewAdr variant_node
class T46_cli_driver_cli_driver_AdrBaselineSnapshotInput_NonSemanticFix variant_node
class T46_cli_driver_cli_driver_AdrBaselineSnapshotInput_Escalation variant_node
class T46_cli_driver_cli_driver_AdrBaselineSnapshotInput__self dto
...
class F53_cli_cli_cli__commands__adr_baseline__resolve_for_read free_function
class F53_cli_cli_cli__commands__adr_baseline__resolve_for_read function_node
class F54_cli_cli_cli__commands__adr_baseline__resolve_for_write free_function
class F54_cli_cli_cli__commands__adr_baseline__resolve_for_write function_node
```
