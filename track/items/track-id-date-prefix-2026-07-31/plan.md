...
- [ ] **T002**: `apps/cli-composition/src/track/mod.rs` test module、`apps/cli-composition/src/track/branch_strategy.rs`、`apps/cli-composition/src/track/resolution.rs` に `TrackCompositionRoot::{track_init, track_branch_create, track_resolve_id}` の date-prefixed fixture 回帰試験を追加する。D1; IN-02、IN-03; CN-02; AC-02、AC-04。
