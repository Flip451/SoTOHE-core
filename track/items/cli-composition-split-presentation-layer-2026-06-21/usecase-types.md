...
| ReviewClassifyService | application_service | — | fn classify(&self, paths: Vec<String>, track_id: Option<String>, items_dir: std::path::PathBuf) -> Result<Vec<(String, String)>, String> | 🔵 | 🔵 |
| ReviewFilesService | application_service | — | fn files(&self, scope: String, track_id: Option<String>, items_dir: std::path::PathBuf) -> Result<Vec<String>, String> | 🔵 | 🔵 |
| ReviewGetBriefingService | application_service | — | fn get_briefing(&self, scope: String, track_id: Option<String>, items_dir: std::path::PathBuf) -> Result<Option<String>, String> | 🔵 | 🔵 |
| ReviewResultsService | application_service | — | fn results(&self, track_id: Option<String>, items_dir: std::path::PathBuf, scope: Option<String>, all: bool, limit: u32, round_type: String, no_hint: bool) -> Result<String, String> | 🔵 | 🔵 |
...
| TelemetryReportService | application_service | — | fn report(&self, track_id: &str, items_dir: &std::path::Path) -> Result<String, String> | 🔵 | 🔵 |
