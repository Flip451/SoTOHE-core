...
- [IN-02] capability 実行、agent profile 検証、review 系実行経路は max を含む reasoning effort を一貫して扱い、プロバイダーが受理しない effort 指定を拒否する。 [adr: knowledge/adr/2026-08-02-0151-codex-reasoning-effort-max.md#D1] [tasks: T001]
