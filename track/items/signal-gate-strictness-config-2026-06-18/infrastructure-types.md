...
| infrastructure::verify::catalogue_spec_signals::calc_catalog_spec_for_layer | free_function | — | fn(workspace_root: &std::path::Path, track_id: domain::TrackId, layer_id: domain::tddd::LayerId, catalog_hash_hex: &str) -> domain::verify::VerifyOutcome | 🟡 | 🔵 |
| infrastructure::verify::catalogue_spec_signals::check_catalog_spec_for_layer | free_function | — | fn(workspace_root: &std::path::Path, track_id: domain::TrackId, layer_id: domain::tddd::LayerId, catalog_hash_hex: &str, strict: bool) -> domain::verify::VerifyOutcome | 🟡 | 🔵 |
