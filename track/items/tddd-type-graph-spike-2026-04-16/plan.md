...
- [ ] type_graph_render.rs — mermaid renderer (TypeGraphRenderOptions / EdgeSet / render_type_graph_flat) + unit tests. libs/infrastructure/src/tddd/type_graph_render.rs を新設し mod.rs に登録。TDD: empty graph / single edge / multi-edge / enum shape テスト
