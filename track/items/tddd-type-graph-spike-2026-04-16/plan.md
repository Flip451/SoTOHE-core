...
- [x] CI gate + 生成物可読性検証。cargo make ci 全通過確認。domain-graph.md の生成物を目視確認 (integration test #[ignore])。verification.md に domain 層ノード数・可読性所感・Phase 2 判断材料を記録
