...
- [x] **T004**: .claude/commands/track/commit.md の Step 0 および Step 3 から verification.md への参照を削除し、observations.md を optional source (存在する場合のみ参照) として扱う記述に更新する。Step 3a の「Read spec.md, plan.md, and verification.md」を「Read spec.md and plan.md; if observations.md exists, also read it」相当に書き換える (IN-03、command docs)
