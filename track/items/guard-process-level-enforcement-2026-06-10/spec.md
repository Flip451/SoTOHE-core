...
- [GO-05] core.hooksPath の配備を bootstrap / CI verify / agent runtime setup preflight の三重で担保し、git hooks 層の不在による保護空白を排除する [adr: knowledge/adr/2026-06-10-1630-git-hooks-process-level-enforcement.md#D7, knowledge/adr/2026-06-12-1518-hooks-path-setup-fail-closed.md#D1]
...
- [IN-10] Claude Code / Codex の agent 実行面は、任意 Bash 実行前に core.hooksPath が .githooks を指すことを確認し、未設定または不一致の場合は setup 用の最小コマンド（cargo make bootstrap / git config --local core.hooksPath .githooks）だけを許可して他の Bash を block する runtime setup preflight を持つ（D7 の第3層） [adr: knowledge/adr/2026-06-10-1630-git-hooks-process-level-enforcement.md#D7, knowledge/adr/2026-06-12-1518-hooks-path-setup-fail-closed.md#D1, knowledge/adr/2026-06-12-1518-hooks-path-setup-fail-closed.md#D2] [tasks: T006, T010]
...
- [CN-06] core.hooksPath 未設定時の runtime fail-closed は block-direct-git-ops とは別責務の setup preflight として実装する。setup preflight は hooksPath 設定済みなら allow、未設定なら setup コマンドだけ allow、それ以外の Bash は block する。block-direct-git-ops は直接 git 操作 policy に集中させる [adr: knowledge/adr/2026-06-10-1630-git-hooks-process-level-enforcement.md#D7, knowledge/adr/2026-06-12-1518-hooks-path-setup-fail-closed.md#D1, knowledge/adr/2026-06-12-1518-hooks-path-setup-fail-closed.md#D2] [tasks: T006, T010]
...
- [ ] [AC-11] hooks-path-setup preflight は core.hooksPath 未設定時に任意 Bash を block し、cargo make bootstrap と git config --local core.hooksPath .githooks だけを許可する。core.hooksPath が .githooks に設定済みの場合は通常の Bash を allow し、後続の block-direct-git-ops が直接 git 操作 policy を判定する [adr: knowledge/adr/2026-06-10-1630-git-hooks-process-level-enforcement.md#D7, knowledge/adr/2026-06-12-1518-hooks-path-setup-fail-closed.md#D1, knowledge/adr/2026-06-12-1518-hooks-path-setup-fail-closed.md#D2] [tasks: T006, T010]
