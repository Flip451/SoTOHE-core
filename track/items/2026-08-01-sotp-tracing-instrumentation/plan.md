...
> Build the primary driver and wire the complete local tracing dependency graph before entrypoint use. IN-01, IN-02, IN-04, OUT-01, CN-01, CN-02, CN-03, AC-01, AC-03, AC-04.

- [ ] **T007**: Implement the primary `CommandTraceDriver` that submits a typed completed-command record to the usecase service and maps the result to the existing command outcome. IN-01, IN-02, CN-01, CN-03, AC-01, AC-03.
