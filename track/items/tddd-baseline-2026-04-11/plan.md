...
- [x] tddd/ モジュール構造を domain / infrastructure / cli の 3 層に作成し、既存ファイル (domain_types.rs, domain_types_codec.rs, domain_state_signals.rs) を tddd/ 配下に移動 ec458b7
...
- [x] Baseline codec (encode/decode) を infrastructure 層 tddd/baseline_codec.rs に実装 677998a
- [x] TypeGraph → TypeBaseline 変換を infrastructure 層 tddd/baseline_builder.rs に実装 2162efb
