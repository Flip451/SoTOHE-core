...
- [x] knowledge/strategy/README.md 作成（ディレクトリ目的 + ファイル一覧）
...
- [x] 戦略文書 5 ファイルを tmp/ → knowledge/strategy/ に移動 + 日付サフィックス除去 + .gitignore 除外設定
...
- [x] 全リポジトリの旧 tmp/ パス参照を knowledge/strategy/ パスに修正（移動ファイル内 + ADR + conventions + その他 git tracked ファイル）
- [x] CLAUDE.md + memory + knowledge/adr/README.md 参照更新
