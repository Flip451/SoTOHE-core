...
- [x] **T005**: Complete the catalogue-declared `semantic-dup` public items in `libs/infrastructure/src/semantic_dup/{extractor.rs,fragment_extractor_adapter.rs,embedding.rs,index.rs,noop_adapter.rs,null_insert_proxy.rs}` and their corresponding usecase ports/errors; add feature-enabled rustdoc and signal regression coverage (CN-04, CN-05, AC-07, AC-08).
