...
| VerifyCatalogueSpecRefsError | error_type | — | NonActiveTrack, BranchTrackMismatch, CatalogueNotFound, CatalogueFetchError, InvalidCatalogueHash, SpecNotFound, SpecFetchError, SignalsFetchError | 🔵 |

## Secondary Ports

| Name | Kind | Action | Details | Signal |
|------|------|--------|---------|--------|
| SpecElementHashReader | secondary_port | — | fn read_spec_element_hashes(&self, branch: &str, track_id: &str) -> BlobFetchResult<BTreeMap<SpecElementId, ContentHash>> | 🔵 |
...
| VerifyCatalogueSpecRefs | application_service | — | fn execute(&self, cmd: &VerifyCatalogueSpecRefsCommand) -> Result<Vec<SpecRefFinding>, VerifyCatalogueSpecRefsError> | 🔵 |
...
| VerifyCatalogueSpecRefsCommand | command | — | — | 🔵 |
