...
subgraph cli_composition["cli_composition"]
  ...
  subgraph cli_composition_cli_composition_module_ref_verify["cli_composition::ref_verify"]
    direction TB
  subgraph T52_cli_composition_cli_composition_RefVerifyChainFilter["ref_verify::RefVerifyChainFilter"]
    direction TB
    T52_cli_composition_cli_composition_RefVerifyChainFilter__self[RefVerifyChainFilter]
    T52_cli_composition_cli_composition_RefVerifyChainFilter_Chain1[Chain1]
    T52_cli_composition_cli_composition_RefVerifyChainFilter_Chain2[Chain2]
    T52_cli_composition_cli_composition_RefVerifyChainFilter_All[All]
  end
  ...
  subgraph T54_cli_composition_cli_composition_RefVerifyVerdictFilter["ref_verify::RefVerifyVerdictFilter"]
    direction TB
    T54_cli_composition_cli_composition_RefVerifyVerdictFilter__self[RefVerifyVerdictFilter]
    T54_cli_composition_cli_composition_RefVerifyVerdictFilter_FailPending[FailPending]
    T54_cli_composition_cli_composition_RefVerifyVerdictFilter_Pass[Pass]
    T54_cli_composition_cli_composition_RefVerifyVerdictFilter_Fail[Fail]
    T54_cli_composition_cli_composition_RefVerifyVerdictFilter_Pending[Pending]
    T54_cli_composition_cli_composition_RefVerifyVerdictFilter_All[All]
  end
  end
end
subgraph cli["cli"]
...
T53_cli_composition_cli_composition_RefVerifyResultsInput__self --o|chain| T52_cli_composition_cli_composition_RefVerifyChainFilter__self
T53_cli_composition_cli_composition_RefVerifyResultsInput__self --o|verdict| T54_cli_composition_cli_composition_RefVerifyVerdictFilter__self
...
class T44_cli_driver_cli_driver_RefVerifyVerdictSelect__self dto
class T52_cli_composition_cli_composition_RefVerifyChainFilter_Chain1 variant_node
class T52_cli_composition_cli_composition_RefVerifyChainFilter_Chain2 variant_node
class T52_cli_composition_cli_composition_RefVerifyChainFilter_All variant_node
class T52_cli_composition_cli_composition_RefVerifyChainFilter__self dto
...
class T54_cli_composition_cli_composition_RefVerifyVerdictFilter_FailPending variant_node
class T54_cli_composition_cli_composition_RefVerifyVerdictFilter_Pass variant_node
class T54_cli_composition_cli_composition_RefVerifyVerdictFilter_Fail variant_node
class T54_cli_composition_cli_composition_RefVerifyVerdictFilter_Pending variant_node
class T54_cli_composition_cli_composition_RefVerifyVerdictFilter_All variant_node
class T54_cli_composition_cli_composition_RefVerifyVerdictFilter__self dto
