...
- [x] docs: ADR `knowledge/adr/2026-04-18-1400-tddd-ci-gate-and-signals-separation.md` の Status を Proposed → Accepted に更新。関連 ADR から本 ADR へのリンクが必要なら追加 (Referenced By セクション等)。
