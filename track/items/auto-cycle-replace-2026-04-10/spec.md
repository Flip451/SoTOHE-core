...
---
status: approved
approved_at: "2026-04-10T12:58:18Z"
version: "1.0.0"
---
...
- Makefile.toml に cargo make track-signals ラッパーを追加し、track:plan コマンドに spec-approve / track-signals ステップを明記 [source: discussion — planning session 2026-04-10] [tasks: T003]
...
## Acceptance Criteria
- [ ] full-cycle.md がタスクごとの implement → review (zero_findings) → cargo make ci → commit ループを定義しており、デフォルトのコミットメッセージ確認・--auto による自動生成・失敗時のタスク停止とステータス報告を含み、transitional compatibility の位置づけが削除され正式コマンドとして記述されている [source: feedback — user request 2026-04-08] [tasks: T001]
- [ ] SKILL.md の full-cycle 参照が新セマンティクスと整合している [source: feedback — user request 2026-04-08] [tasks: T002]
- [ ] Makefile.toml に cargo make track-signals ラッパーが追加され、track:plan コマンドに spec-approve / track-signals ステップが明記されている [source: discussion — planning session 2026-04-10] [tasks: T003]
