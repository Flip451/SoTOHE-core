...
| Name | Kind | Action | Details | Signal | Cat-Spec |
|------|------|--------|---------|--------|----------|
| FsImplCatalogSignalReader | secondary_adapter | add | impl ImplCatalogSignalReaderPort | 🟡 | 🔵 |
| FsTaskContractReader | secondary_adapter | add | impl TaskContractReaderPort | 🟡 | 🔵 |
