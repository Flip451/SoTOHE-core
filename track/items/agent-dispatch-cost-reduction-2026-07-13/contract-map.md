...
subgraph domain["domain"]
  ...
  subgraph T35_domain_domain_EvaluatorContractHash["tddd::type_signals_doc::EvaluatorContractHash"]
    direction TB
    T35_domain_domain_EvaluatorContractHash__self[EvaluatorContractHash]
    T35_domain_domain_EvaluatorContractHash_new([new])
    T35_domain_domain_EvaluatorContractHash_as_digest([as_digest])
  end
  ...
  subgraph T37_domain_domain_LiveRustdocSnapshotHash["tddd::type_signals_doc::LiveRustdocSnapshotHash"]
    direction TB
    T37_domain_domain_LiveRustdocSnapshotHash__self[LiveRustdocSnapshotHash]
    T37_domain_domain_LiveRustdocSnapshotHash_new([new])
    T37_domain_domain_LiveRustdocSnapshotHash_as_digest([as_digest])
  end
  subgraph T39_domain_domain_LiveRustdocSnapshotStatus["tddd::type_signals_doc::LiveRustdocSnapshotStatus"]
    direction TB
    T39_domain_domain_LiveRustdocSnapshotStatus__self[LiveRustdocSnapshotStatus]
    T39_domain_domain_LiveRustdocSnapshotStatus_Verified[Verified]
    T39_domain_domain_LiveRustdocSnapshotStatus_Missing[Missing]
    T39_domain_domain_LiveRustdocSnapshotStatus_ReadFailed[ReadFailed]
    T39_domain_domain_LiveRustdocSnapshotStatus_ParseFailed[ParseFailed]
    T39_domain_domain_LiveRustdocSnapshotStatus_HashMismatch[HashMismatch]
  end
  subgraph T43_domain_domain_RustdocExtractionContractHash["tddd::type_signals_doc::RustdocExtractionContractHash"]
    direction TB
    T43_domain_domain_RustdocExtractionContractHash__self[RustdocExtractionContractHash]
    T43_domain_domain_RustdocExtractionContractHash_new([new])
    T43_domain_domain_RustdocExtractionContractHash_as_digest([as_digest])
  end
  ...
  subgraph T38_domain_domain_TypeSignalsCurrentInputs["tddd::type_signals_doc::TypeSignalsCurrentInputs"]
    direction TB
    T38_domain_domain_TypeSignalsCurrentInputs__self[TypeSignalsCurrentInputs]
    T38_domain_domain_TypeSignalsCurrentInputs_new([new])
    T38_domain_domain_TypeSignalsCurrentInputs_declaration_hash([declaration_hash])
    T38_domain_domain_TypeSignalsCurrentInputs_implementation_input_hash([implementation_input_hash])
    T38_domain_domain_TypeSignalsCurrentInputs_baseline_hash([baseline_hash])
    T38_domain_domain_TypeSignalsCurrentInputs_evaluator_contract_hash([evaluator_contract_hash])
    T38_domain_domain_TypeSignalsCurrentInputs_rustdoc_extraction_contract_hash([rustdoc_extraction_contract_hash])
  end
  subgraph T33_domain_domain_TypeSignalsDocument["tddd::type_signals_doc::TypeSignalsDocument"]
    ...
    T33_domain_domain_TypeSignalsDocument_freshness([freshness])
  ...
  subgraph T34_domain_domain_TypeSignalsFreshness["tddd::type_signals_doc::TypeSignalsFreshness"]
    direction TB
    T34_domain_domain_TypeSignalsFreshness__self[TypeSignalsFreshness]
    T34_domain_domain_TypeSignalsFreshness_new([new])
    T34_domain_domain_TypeSignalsFreshness_declaration_hash([declaration_hash])
    T34_domain_domain_TypeSignalsFreshness_implementation_input_hash([implementation_input_hash])
    T34_domain_domain_TypeSignalsFreshness_baseline_hash([baseline_hash])
    T34_domain_domain_TypeSignalsFreshness_live_rustdoc_snapshot_hash([live_rustdoc_snapshot_hash])
    T34_domain_domain_TypeSignalsFreshness_evaluator_contract_hash([evaluator_contract_hash])
    T34_domain_domain_TypeSignalsFreshness_rustdoc_extraction_contract_hash([rustdoc_extraction_contract_hash])
  end
  ...
  subgraph T38_domain_domain_TypeSignalsReuseDecision["tddd::type_signals_doc::TypeSignalsReuseDecision"]
    ...
    T38_domain_domain_TypeSignalsReuseDecision_ReevaluateWithSnapshot[ReevaluateWithSnapshot]
...
subgraph usecase["usecase"]
  ...
  subgraph usecase_usecase_module_provider_session["usecase::provider_session"]
    direction TB
  subgraph T44_usecase_usecase_ExecutionContractFingerprint["provider_session::ExecutionContractFingerprint"]
    direction TB
    T44_usecase_usecase_ExecutionContractFingerprint__self[ExecutionContractFingerprint]
    T44_usecase_usecase_ExecutionContractFingerprint_new([new])
    T44_usecase_usecase_ExecutionContractFingerprint_as_digest([as_digest])
  end
  subgraph T41_usecase_usecase_ProviderSessionCacheEntry["provider_session::ProviderSessionCacheEntry"]
    ...
    T41_usecase_usecase_ProviderSessionCacheEntry_fingerprint([fingerprint])
  end
  subgraph T41_usecase_usecase_ProviderSessionCacheError["provider_session::ProviderSessionCacheError"]
    ...
    T41_usecase_usecase_ProviderSessionCacheError_Io[Io]
    T41_usecase_usecase_ProviderSessionCacheError_Codec[Codec]
    T41_usecase_usecase_ProviderSessionCacheError_Symlink[Symlink]
    T41_usecase_usecase_ProviderSessionCacheError_Path[Path]
  end
  ...
  subgraph R58_usecase_usecase_CapabilityExecutionContractFingerprintPort["provider_session::CapabilityExecutionContractFingerprintPort"]
    direction TB
    R58_usecase_usecase_CapabilityExecutionContractFingerprintPort__self[CapabilityExecutionContractFingerprintPort]
    R58_usecase_usecase_CapabilityExecutionContractFingerprintPort_capability_fingerprint([capability_fingerprint])
  end
  ...
  subgraph R56_usecase_usecase_ReviewerExecutionContractFingerprintPort["provider_session::ReviewerExecutionContractFingerprintPort"]
    direction TB
    R56_usecase_usecase_ReviewerExecutionContractFingerprintPort__self[ReviewerExecutionContractFingerprintPort]
    R56_usecase_usecase_ReviewerExecutionContractFingerprintPort_reviewer_fingerprint([reviewer_fingerprint])
  end
  end
...
subgraph infrastructure["infrastructure"]
  ...
  subgraph T71_infrastructure_infrastructure_Sha256ExecutionContractFingerprintAdapter["provider_session::Sha256ExecutionContractFingerprintAdapter"]
    direction TB
    T71_infrastructure_infrastructure_Sha256ExecutionContractFingerprintAdapter__self[Sha256ExecutionContractFingerprintAdapter]
    T71_infrastructure_infrastructure_Sha256ExecutionContractFingerprintAdapter_new([new])
  end
  end
...
T26_domain_domain_BaselineHash_new --o T26_domain_domain_Sha256Digest__self
T26_domain_domain_BaselineHash_new --> T26_domain_domain_BaselineHash__self
T26_domain_domain_BaselineHash_as_digest --> T26_domain_domain_Sha256Digest__self
...
T35_domain_domain_EvaluatorContractHash_new --o T26_domain_domain_Sha256Digest__self
T35_domain_domain_EvaluatorContractHash_new --> T35_domain_domain_EvaluatorContractHash__self
T35_domain_domain_EvaluatorContractHash_as_digest --> T26_domain_domain_Sha256Digest__self
...
T37_domain_domain_LiveRustdocSnapshotHash_new --o T26_domain_domain_Sha256Digest__self
T37_domain_domain_LiveRustdocSnapshotHash_new --> T37_domain_domain_LiveRustdocSnapshotHash__self
T37_domain_domain_LiveRustdocSnapshotHash_as_digest --> T26_domain_domain_Sha256Digest__self
T39_domain_domain_LiveRustdocSnapshotStatus_Verified --o T37_domain_domain_LiveRustdocSnapshotHash__self
T43_domain_domain_RustdocExtractionContractHash_new --o T26_domain_domain_Sha256Digest__self
T43_domain_domain_RustdocExtractionContractHash_new --> T43_domain_domain_RustdocExtractionContractHash__self
T43_domain_domain_RustdocExtractionContractHash_as_digest --> T26_domain_domain_Sha256Digest__self
...
T38_domain_domain_TypeSignalsCurrentInputs_new --o T38_domain_domain_CatalogueDeclarationHash__self
T38_domain_domain_TypeSignalsCurrentInputs_new --o T37_domain_domain_ImplementationInputHash__self
T38_domain_domain_TypeSignalsCurrentInputs_new --o T26_domain_domain_BaselineHash__self
T38_domain_domain_TypeSignalsCurrentInputs_new --o T35_domain_domain_EvaluatorContractHash__self
T38_domain_domain_TypeSignalsCurrentInputs_new --o T43_domain_domain_RustdocExtractionContractHash__self
T38_domain_domain_TypeSignalsCurrentInputs_new --> T38_domain_domain_TypeSignalsCurrentInputs__self
T38_domain_domain_TypeSignalsCurrentInputs_declaration_hash --> T38_domain_domain_CatalogueDeclarationHash__self
T38_domain_domain_TypeSignalsCurrentInputs_implementation_input_hash --> T37_domain_domain_ImplementationInputHash__self
T38_domain_domain_TypeSignalsCurrentInputs_baseline_hash --> T26_domain_domain_BaselineHash__self
T38_domain_domain_TypeSignalsCurrentInputs_evaluator_contract_hash --> T35_domain_domain_EvaluatorContractHash__self
T38_domain_domain_TypeSignalsCurrentInputs_rustdoc_extraction_contract_hash --> T43_domain_domain_RustdocExtractionContractHash__self
T33_domain_domain_TypeSignalsDocument_new --o T34_domain_domain_TypeSignalsFreshness__self
...
T33_domain_domain_TypeSignalsDocument_with_schema_version --o T34_domain_domain_TypeSignalsFreshness__self
...
T33_domain_domain_TypeSignalsDocument_freshness --> T34_domain_domain_TypeSignalsFreshness__self
T33_domain_domain_TypeSignalsDocument_declaration_hash --> T38_domain_domain_CatalogueDeclarationHash__self
T34_domain_domain_TypeSignalsFreshness_new --o T38_domain_domain_CatalogueDeclarationHash__self
T34_domain_domain_TypeSignalsFreshness_new --o T37_domain_domain_ImplementationInputHash__self
T34_domain_domain_TypeSignalsFreshness_new --o T26_domain_domain_BaselineHash__self
T34_domain_domain_TypeSignalsFreshness_new --o T37_domain_domain_LiveRustdocSnapshotHash__self
T34_domain_domain_TypeSignalsFreshness_new --o T35_domain_domain_EvaluatorContractHash__self
T34_domain_domain_TypeSignalsFreshness_new --o T43_domain_domain_RustdocExtractionContractHash__self
T34_domain_domain_TypeSignalsFreshness_new --> T34_domain_domain_TypeSignalsFreshness__self
T34_domain_domain_TypeSignalsFreshness_declaration_hash --> T38_domain_domain_CatalogueDeclarationHash__self
T34_domain_domain_TypeSignalsFreshness_implementation_input_hash --> T37_domain_domain_ImplementationInputHash__self
T34_domain_domain_TypeSignalsFreshness_baseline_hash --> T26_domain_domain_BaselineHash__self
T34_domain_domain_TypeSignalsFreshness_live_rustdoc_snapshot_hash --> T37_domain_domain_LiveRustdocSnapshotHash__self
T34_domain_domain_TypeSignalsFreshness_evaluator_contract_hash --> T35_domain_domain_EvaluatorContractHash__self
T34_domain_domain_TypeSignalsFreshness_rustdoc_extraction_contract_hash --> T43_domain_domain_RustdocExtractionContractHash__self
...
F71_domain_domain_domain__tddd__type_signals_doc__decide_type_signals_reuse --o T34_domain_domain_TypeSignalsFreshness__self
F71_domain_domain_domain__tddd__type_signals_doc__decide_type_signals_reuse --o T38_domain_domain_TypeSignalsCurrentInputs__self
F71_domain_domain_domain__tddd__type_signals_doc__decide_type_signals_reuse --o T39_domain_domain_LiveRustdocSnapshotStatus__self
...
T35_usecase_usecase_CapabilityExecError_ProfileResolution --o T30_usecase_usecase_CapabilityName__self
T35_usecase_usecase_CapabilityExecError_ProfileResolution --o T39_usecase_usecase_CapabilityFailureDetail__self
T35_usecase_usecase_CapabilityExecError_ExecutionModeRejected --o T30_usecase_usecase_CapabilityName__self
T35_usecase_usecase_CapabilityExecError_ModelMissing --o T30_usecase_usecase_CapabilityName__self
T35_usecase_usecase_CapabilityExecError_EffortMissing --o T30_usecase_usecase_CapabilityName__self
T35_usecase_usecase_CapabilityExecError_UnsupportedProvider --o T28_usecase_usecase_ProviderName__self
T35_usecase_usecase_CapabilityExecError_SourceValidation --o T34_usecase_usecase_CapabilityFilePath__self
T35_usecase_usecase_CapabilityExecError_SourceValidation --o T39_usecase_usecase_CapabilityFailureDetail__self
T35_usecase_usecase_CapabilityExecError_AdapterPreflight --o T30_usecase_usecase_CapabilityName__self
T35_usecase_usecase_CapabilityExecError_AdapterPreflight --o T28_usecase_usecase_ProviderName__self
T35_usecase_usecase_CapabilityExecError_AdapterPreflight --o T39_usecase_usecase_CapabilityFailureDetail__self
T35_usecase_usecase_CapabilityExecError_DispatchFailed --o T28_usecase_usecase_ProviderName__self
T35_usecase_usecase_CapabilityExecError_DispatchFailed --o T39_usecase_usecase_CapabilityFailureDetail__self
...
T44_usecase_usecase_ExecutionContractFingerprint_new --o T26_domain_domain_Sha256Digest__self
T44_usecase_usecase_ExecutionContractFingerprint_new --> T44_usecase_usecase_ExecutionContractFingerprint__self
T44_usecase_usecase_ExecutionContractFingerprint_as_digest --> T26_domain_domain_Sha256Digest__self
...
T41_usecase_usecase_ProviderSessionCacheEntry_new --o T44_usecase_usecase_ExecutionContractFingerprint__self
...
T41_usecase_usecase_ProviderSessionCacheEntry_fingerprint --> T44_usecase_usecase_ExecutionContractFingerprint__self
...
T39_usecase_usecase_ProviderSessionCacheKey_TrackCapability --o|target_artifacts| T33_usecase_usecase_TargetArtifactSet__self
...
R58_usecase_usecase_CapabilityExecutionContractFingerprintPort_capability_fingerprint --o T30_usecase_usecase_CapabilityName__self
R58_usecase_usecase_CapabilityExecutionContractFingerprintPort_capability_fingerprint --> T44_usecase_usecase_ExecutionContractFingerprint__self
R58_usecase_usecase_CapabilityExecutionContractFingerprintPort_capability_fingerprint --> T41_usecase_usecase_ProviderSessionCacheError__self
...
R56_usecase_usecase_ReviewerExecutionContractFingerprintPort_reviewer_fingerprint --o T23_domain_domain_ScopeName__self
R56_usecase_usecase_ReviewerExecutionContractFingerprintPort_reviewer_fingerprint --> T44_usecase_usecase_ExecutionContractFingerprint__self
R56_usecase_usecase_ReviewerExecutionContractFingerprintPort_reviewer_fingerprint --> T41_usecase_usecase_ProviderSessionCacheError__self
...
T71_infrastructure_infrastructure_Sha256ExecutionContractFingerprintAdapter_new --> T71_infrastructure_infrastructure_Sha256ExecutionContractFingerprintAdapter__self
...
T71_infrastructure_infrastructure_Sha256ExecutionContractFingerprintAdapter__self -.impl.-> R58_usecase_usecase_CapabilityExecutionContractFingerprintPort__self
T71_infrastructure_infrastructure_Sha256ExecutionContractFingerprintAdapter__self -.impl.-> R56_usecase_usecase_ReviewerExecutionContractFingerprintPort__self
...
class T35_domain_domain_EvaluatorContractHash_new method_node
class T35_domain_domain_EvaluatorContractHash_as_digest method_node
class T35_domain_domain_EvaluatorContractHash__self value_object
...
class T37_domain_domain_LiveRustdocSnapshotHash_new method_node
class T37_domain_domain_LiveRustdocSnapshotHash_as_digest method_node
class T37_domain_domain_LiveRustdocSnapshotHash__self value_object
class T39_domain_domain_LiveRustdocSnapshotStatus_Verified variant_node
class T39_domain_domain_LiveRustdocSnapshotStatus_Missing variant_node
class T39_domain_domain_LiveRustdocSnapshotStatus_ReadFailed variant_node
class T39_domain_domain_LiveRustdocSnapshotStatus_ParseFailed variant_node
class T39_domain_domain_LiveRustdocSnapshotStatus_HashMismatch variant_node
class T39_domain_domain_LiveRustdocSnapshotStatus__self value_object
class T43_domain_domain_RustdocExtractionContractHash_new method_node
class T43_domain_domain_RustdocExtractionContractHash_as_digest method_node
class T43_domain_domain_RustdocExtractionContractHash__self value_object
...
class T38_domain_domain_TypeSignalsCurrentInputs_new method_node
class T38_domain_domain_TypeSignalsCurrentInputs_declaration_hash method_node
class T38_domain_domain_TypeSignalsCurrentInputs_implementation_input_hash method_node
class T38_domain_domain_TypeSignalsCurrentInputs_baseline_hash method_node
class T38_domain_domain_TypeSignalsCurrentInputs_evaluator_contract_hash method_node
class T38_domain_domain_TypeSignalsCurrentInputs_rustdoc_extraction_contract_hash method_node
class T38_domain_domain_TypeSignalsCurrentInputs__self value_object
...
class T33_domain_domain_TypeSignalsDocument_freshness method_node
...
class T34_domain_domain_TypeSignalsFreshness_new method_node
class T34_domain_domain_TypeSignalsFreshness_declaration_hash method_node
class T34_domain_domain_TypeSignalsFreshness_implementation_input_hash method_node
class T34_domain_domain_TypeSignalsFreshness_baseline_hash method_node
class T34_domain_domain_TypeSignalsFreshness_live_rustdoc_snapshot_hash method_node
class T34_domain_domain_TypeSignalsFreshness_evaluator_contract_hash method_node
class T34_domain_domain_TypeSignalsFreshness_rustdoc_extraction_contract_hash method_node
class T34_domain_domain_TypeSignalsFreshness__self value_object
...
class T38_domain_domain_TypeSignalsReuseDecision_ReevaluateWithSnapshot variant_node
...
class T44_usecase_usecase_ExecutionContractFingerprint_new method_node
class T44_usecase_usecase_ExecutionContractFingerprint_as_digest method_node
class T44_usecase_usecase_ExecutionContractFingerprint__self value_object
...
class T41_usecase_usecase_ProviderSessionCacheEntry_fingerprint method_node
class T41_usecase_usecase_ProviderSessionCacheEntry__self value_object
class T41_usecase_usecase_ProviderSessionCacheError_Io variant_node
class T41_usecase_usecase_ProviderSessionCacheError_Codec variant_node
class T41_usecase_usecase_ProviderSessionCacheError_Symlink variant_node
class T41_usecase_usecase_ProviderSessionCacheError_Path variant_node
...
class R58_usecase_usecase_CapabilityExecutionContractFingerprintPort_capability_fingerprint method_node
class R58_usecase_usecase_CapabilityExecutionContractFingerprintPort__self secondary_port
...
class R56_usecase_usecase_ReviewerExecutionContractFingerprintPort_reviewer_fingerprint method_node
class R56_usecase_usecase_ReviewerExecutionContractFingerprintPort__self secondary_port
...
class T71_infrastructure_infrastructure_Sha256ExecutionContractFingerprintAdapter_new method_node
class T71_infrastructure_infrastructure_Sha256ExecutionContractFingerprintAdapter__self secondary_adapter
