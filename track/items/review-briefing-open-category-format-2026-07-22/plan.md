...
- [x] **T001**: Update `.harness/custom/review-prompts/domain.md`, `usecase.md`, `infrastructure.md`, `cli.md`, `cli_composition.md`, `cli_driver.md`, and `harness-policy.md`. IN-01/IN-02/IN-03/OUT-02/OUT-03/CN-01/CN-03/AC-01/AC-02.
...
- [x] **T002**: Individually adjudicate and update the existing `.harness/custom/review-prompts/adr.md`, `spec.md`, `types.md`, and `impl-plan.md`. IN-02/IN-03/IN-04/IN-05/OUT-01/OUT-02/CN-02/AC-02/AC-03/AC-04.
...
- [x] **T003**: Add a briefing role-statement/category check to `.claude/rules/09-maintainer-checklist.md`. IN-06/AC-05.
