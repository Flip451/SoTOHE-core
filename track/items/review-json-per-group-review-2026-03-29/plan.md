...
- [ ] Usecase: check-approved を latest-success per-group fast/final 判定へ再設計し、global round sync を廃止
...
- [ ] CLI: review status / stale reason / final requirement 表示を review.json ベースへ更新
- [ ] Verification: codec/usecase/CLI 回帰テスト追加 + cargo make ci で全通確認
