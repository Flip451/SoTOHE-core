...
- [~] **T035**: `libs/usecase/src/phase_command.rs` の phase enter orchestration、host-bearing `PhaseEnterCommand`、enter outcome、shared service / interactor を catalogue shape に適応する。dispatch-boundary host forwarding と、provider-neutral configured command と actual invoked argv を分離して `ProgramExecutionRecord` に監査記録する処理、および関連 tests を更新する。IN-02、IN-11、CN-03、AC-02、AC-13。
